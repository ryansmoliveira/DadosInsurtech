Projeto de Análise de Risco Territorial para Seguros
Visão Geral

Este projeto tem como objetivo analisar dados de criminalidade para identificar padrões espaciais de risco que possam auxiliar seguradoras na avaliação de exposição a perdas e na definição de estratégias de precificação.
Foram utilizados dados de roubos de celulares e roubos a transeuntes, com aplicação de técnicas de análise exploratória de dados (EDA), estatística descritiva, detecção de outliers e análise de correlação.
